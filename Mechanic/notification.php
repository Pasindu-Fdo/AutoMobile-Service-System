<?php
    ...
    ?>
    <link rel="stylesheet" href="/AutoMobile Project/Mechanic/assets/css/notification.css">
    ...
    <script src="/AutoMobile Project/Mechanic/assets/js/notification.js"></script>
    <script>
