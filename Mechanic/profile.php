    <?php
        ...
        $stmt->bind_param("i", $officer_id); // Assuming cus_id is an integer
        $stmt->execute(); // Execute the statement
        $query_run = $stmt->get_result(); // Get the result
        $user = mysqli_fetch_assoc($query_run);

    ?>
    <link rel="stylesheet" href="/AutoMobile Project/Mechanic/assets/css/profile.css">
    <!-- Cropper.js CSS -->
    ...
    <div class="changeProfile-modal" id="profile-modal">
        <div class="changeProfile-modal-content">
            <button id="take-photo">Take a Photo</button>
            <button id="select-photo">Select a Photo</button>
    ...
    <script src="/AutoMobile Project/Mechanic/assets/js/profile.js"></script>
    <!-- Cropper.js JS -->
