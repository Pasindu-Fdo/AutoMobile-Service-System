...
if (isset($_POST['updateBtn'])) {
        ...
        if (in_array($fileExt, $allowed)) {
            if ($fileSize < 5000000) {
                ...
                if (move_uploaded_file($fileTmpName, $fileDestination)) {
                    ...
                    $_SESSION['auth_user']['profile_pic'] = "/AutoMobile Project/User/assets/img/profile_pics/" . $fileNewName;
                } else {
    ...
    $update_query = "UPDATE customer SET $updateFields WHERE cus_Id = $userId";
    ...
    header('Location: ../profile.php?error=no_form_submitted');
    exit();
}
